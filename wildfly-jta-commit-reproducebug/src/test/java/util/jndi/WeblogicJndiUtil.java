 ...
 * @author b7godin
 */
public final class WeblogicJndiUtil {

    public static final WeblogicJndiUtil SINGLETON = new WeblogicJndiUtil();

    InitialContext ictx = WeblogicContextFactory.SINGLETON.create();

    private WeblogicJndiUtil() {
    }
    ...
    public <T> T resolveBean(String war, String beanName, Class<T> remoteInterface) {
        ...
        try {
            ...
            Logger.getLogger(WeblogicJndiUtil.class.getName()).log(Level.SEVERE, null, ex);
        }
